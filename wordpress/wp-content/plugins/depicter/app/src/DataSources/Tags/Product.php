	...
	public function getAssetBlocks( array $args = [] ){
		...
		return [
			...
			[
				...
				'func'  => null,
				'payload' => [
					'tag' => 'product->shortDescription|wTrim(50)'
				]
			],
			[
				'id'    => 'stockStatus',
