...
- Now you can add Ken-burns effect to the slide background image (PRO).
...
- An issue with localization of the editor fixed.
- An issue with disabling hover effect on tablet and mobile breakpoints fixed.
